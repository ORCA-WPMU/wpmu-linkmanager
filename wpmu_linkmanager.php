...
class wplerlm {
	...
	public function add_menu() {
		add_menu_page( __( 'WPler LinkManager', wplerlm::get_textdomain() ), __( 'LinkManager', wplerlm::get_textdomain() ), 'manage_network_options', WPLER_LM_SLUG, array( $this, 'links_page' ) );
		add_submenu_page( WPLER_LM_SLUG, __( 'WPler LinkManager', wplerlm::get_textdomain() ), __( 'Links', wplerlm::get_textdomain() ), 'manage_network_options', WPLER_LM_SLUG, array( $this, 'links_page' ) );
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td><select name="blogid" id="blogid" size="1">
						<?php
						$blogs = $wpdb->get_col( $wpdb->prepare( "SELECT blog_id FROM {$wpdb->blogs} WHERE public = '1' && archived = '0' && mature = '0' && spam = '0' && deleted = '0'" ) );
                ...
                <tr>
                    ...
                    <td><input type="text" name="tourl" id="tourl" class="widefat" value="<?php echo !empty( $link->tourl ) ? $link->tourl : ''; ?>" placeholder="http://" /></td>
                </tr>
                <tr>
...
PRIMARY KEY  (link_id)
			...
			printf( '<div class="updated">%s</div>', __( 'This plugin works only into multisites', wplerlm::get_textdomain() ) );
		}
	}
	/**
